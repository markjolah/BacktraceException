...
macro(add_external_dependency)
    ...
    foreach(_ExtProject_Config_prop ${_ExtProject_Config_Properties})
        foreach(_ExtProject_Config_type ${_ExtProject_Config_Types})
    ...
    foreach(_ExtProject_print_prop ${_ExtProject_Print_Properties})
