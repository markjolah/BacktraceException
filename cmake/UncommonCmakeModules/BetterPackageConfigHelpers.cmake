...
# 2018
# Modified to allow lists of variables to be transformed as PATH_VARS the same way as individual variables
...
function(BETTER_CONFIGURE_PACKAGE_CONFIG_FILE _inputFile _outputFile)
  ...
  foreach(var ${CCF_PATH_VARS})
    ...
    set(tvar)
    foreach(v IN ITEMS ${var}) #Modified to allow lists of items.
      if(IS_ABSOLUTE "${${v}}")
        string(REPLACE "${installPrefix}" "\${PACKAGE_PREFIX_DIR}" tv "${${v}}")
      else()
        set(tv "\${PACKAGE_PREFIX_DIR}/${${v}}")
      endif()
      list(APPEND tvar ${tv})
    endforeach()
    set(PACKAGE_${var} ${tvar})
    unset(tvar)
  endforeach()
