...
# 01-2018
#
# Toolchain-x86_64-gcc6_5-linux-gnu.cmake
#
...
set(CMAKE_CXX_COMPILER g++-6.5.0)

set(CMAKE_FIND_ROOT_PATH $ENV{X86_64_GCC6_5_LINUX_GNU_ROOT})
set(CMAKE_SYSROOT $ENV{X86_64_GCC6_5_LINUX_GNU_ROOT}) #This sets --sysroot= on linking

set(CMAKE_PREFIX_PATH $ENV{X86_64_GCC6_5_LINUX_GNU_ROOT}) #This root for pkg-config in FindPkgConfig
...
if(OPT_FIXUP_DEPENDENCIES)
    ...
    if(NOT _install_hook_activated)
        ...
        message(STATUS "gcc6_5 Toolchain option: OPT_FIXUP_DEPENDENCIES:${OPT_FIXUP_DEPENDENCIES}")
        message(STATUS "gcc6_5 Toolchain option: OPT_FIXUP_DEPENDENCIES_AUTO:${OPT_FIXUP_DEPENDENCIES_AUTO}")
        message(STATUS "gcc6_5 Toolchain option: OPT_FIXUP_DEPENDENCIES_BUILD_TREE:${OPT_FIXUP_DEPENDENCIES_BUILD_TREE}")
        message(STATUS "gcc6_5 Toolchain option: OPT_FIXUP_DEPENDENCIES_COPY_GCC_LIBS:${OPT_FIXUP_DEPENDENCIES_COPY_GCC_LIBS}")
        message(STATUS "gcc6_5 Toolchain option: OPT_FIXUP_DEPENDENCIES_COPY_GLIBC_LIBS:${OPT_FIXUP_DEPENDENCIES_COPY_GLIBC_LIBS}")
        message(STATUS "gcc6_5 Toolchain option: OPT_FIXUP_SET_RPATH:${OPT_FIXUP_SET_RPATH}")
        message(STATUS "gcc6_5 Toolchain option: OPT_FIXUP_SET_RUNPATH:${OPT_FIXUP_SET_RUNPATH}")
        ...
        if(OPT_FIXUP_DEPENDENCIES_AUTO)
            ...
            if(NOT _FixupDependencies_Path)
                message(FATAL_ERROR "[Toolchain-x86_64-gcc6_5-linux-gnu]: Could not locate FixupDependencies.cmake.  Required to fixup directories locally.")
            endif()
